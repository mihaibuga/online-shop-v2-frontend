            ...
            <div className="p-4 mx-auto lg:max-w-7xl sm:max-w-full">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 max-xl:gap-4 gap-6">
                    {products.map((product, index) => (
                        <div
                            key={index}
                            className="group flex flex-col bg-white border rounded-2xl p-5 cursor-pointer hover:border-blue-600 transition-all relative duration-200"
                        >
                            <div className="bg-gray-100 w-10 z-10 h-10 flex items-center justify-center rounded-full cursor-pointer absolute top-4 right-4">
                                <svg
