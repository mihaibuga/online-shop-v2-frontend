...
const SidebarCloseButton = ({ sidebar, isSidebarExpanded, toggleSidebarDisplay, additionalClasses }: Props) => {
    ...
    return (
        <button
            ...
            className={`${additionalClasses ? `${additionalClasses}${" "}` : ""}absolute top-2 right-2 text-[#222831] dark:text-[#EEEEEE] bg-transparent hover:bg-gray-200 hover:text-gray-900 dark:hover:text-[#222831] rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center z-25`}
        >
