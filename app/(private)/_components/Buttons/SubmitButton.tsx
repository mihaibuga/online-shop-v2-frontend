...
const SubmitButton = ({ isDisabled, isSubmitting, clickHandler, defaultText, textWhileSubmitting }: Props) => {
    ...
    return (
        <button
            ...
            className={`text-white bg-gray-300 ${
                isDisabled ? "cursor-not-allowed opacity-50" : "bg-blue-700 hover:bg-blue-800"
            } text-center focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800`}
            disabled={isDisabled}
